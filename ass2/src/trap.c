...
trap(struct trapframe *tf)
{
  ...
  // For hybrid scheduling uncomment this
  ...
  //   myproc()->tickcounter=0; // Set tickcounter to 0 after quanta expires
  //   yield();
  // }
  // For SJF scheduling uncomment this
